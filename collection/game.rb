...
class Ship # maybe to be moved to it's own file
    ...
    def initialize
        ...
        @crash = Sound.new("/Users/eitan/Documents/Flatiron/Mod1/ruby-project-guidelines/app/game_sounds/crash2.wav")
    end
...
class Game
    ...
    def initialize(players=1)
        ...
        @start_timer = $FPS * 3
        @started = false
        @music = Music.new('/Users/eitan/Documents/Flatiron/Mod1/ruby-project-guidelines/app/game_sounds/abackground_and_engine.wav')
    end
